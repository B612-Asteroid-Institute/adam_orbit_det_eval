"""Build the v12 LOOO observatory-bias catalog showcase HTML page."""
...
def _diff_cell(ours: float, ref: float) -> str:
    """Render the signed v12 − Veres diff, outlined in orange/red if the
    proportional deviation (ratio) is outside the methodology-gap band.
    Most v12/Veres ratios fall in ~0.7-1.4; literature stop-threshold is ~2x.
...
def render_veres_table(station_only: pd.DataFrame) -> str:
    """Side-by-side comparison of v12 RMS vs Veres 2017 Table 1 RMS."""
...
<table class="data veres-table">
  <thead>
    ...
    <tr>
      <th data-sort="num">v12 RMS [CI]</th>
      <th data-sort="num">Veres Table 1</th>
      <th data-sort="num">v12 − Veres</th>
      <th data-sort="num">v12 RMS [CI]</th>
      <th data-sort="num">Veres Table 1</th>
      <th data-sort="num">v12 − Veres</th>
    </tr>
...
""".strip()
    ...
    intro = """
<p>
  This page presents the <strong>v12 Leave-One-Observatory-Out (LOOO)</strong>
...
<footer>
  ...
  v12 LOOO catalog produced by the cloud pipeline on <strong>{RUN_DATE}</strong>
  ...
  Generated by <code>scripts/build_v12_showcase.py</code>.
</footer>
""".strip()
...
<head>
<meta charset="utf-8">
<title>v12 LOOO observatory-bias catalog</title>
<style>
{CSS}
</style>
</head>
<body>
<div class="container">
  <h1>v12 LOOO observatory-bias catalog</h1>
  ...
  <p>
    ...
    star-catalog debiasing. Of those 13, {n_veres_present} appear in v12 —
    shown below with our per-station RMS placed next to the Veres value and
    the ratio (v12 ÷ Veres). Only <strong>C51 (WISE)</strong> is absent: it
  ...
  <div class="note">
    ...
    preprocessing. v12 residuals are <em>held-out</em> LOOO residuals from a
    fit that excluded the observation, with no catalog debiasing. The
    methodology gap predicts v12 RMS should be slightly <em>larger</em> than
    ...
    <strong>v12 ratios significantly below 1.0 are unexpected</strong> and
    ...
    <strong>v12 − Veres</strong> column is highlighted only when the
    proportional deviation falls outside the methodology-gap band (v12/Veres
...
def main():
    ...
    default_out = repo_root / "reports" / "v12_showcase"

    p = argparse.ArgumentParser(
        description=(
            "Build a self-contained static HTML showcase page for the v12 LOOO "
    ...
    print(f"[v12-showcase] reading catalog: {catalog_dir}")
    data = load_data(catalog_dir, repo_root)
    print(
        f"[v12-showcase]   bias_table rows: {len(data['bias_table'])}; "
